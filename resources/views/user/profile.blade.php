      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/tables/basic-table.html" href="#tables" aria-expanded="false" aria-controls="tables">
            ...
            <div class="row g-0">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets-profile/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Hai, Jennie <i class="mdi mdi-bookmark-outline mdi-24px float-end"></i>
                    </h4>
